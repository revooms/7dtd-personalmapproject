...
def usage():
    print "This program extracts and merges map tiles of all players and writes it in a folder with various zoom" \
          " levels. In order to hide player bases, this program keeps only the oldest version of each tile by default."
    print ""
    print "Usage:"
    print " -g [PATH]"
    print "\tThe folder that contains .map files, i.e. \"C:\\Users..\""
    print " -t [DIRECTORY] (Optional)"
    print "\tThe folder that will contain tiles, i.e. \"tiles\""
    print " -z [INTEGER] (Optional)"
    print "\tZoom level 4-n. Number of tiles to extract around position 0,0 of map."
    print "\tIt is in the form of 4^n tiles. It will extract a grid of 2^n*16 tiles on each side."
    print " -n (Optional)"
    print "\tKeep track of updates and write the last version of tiles. This will show players bases on map."
